...
const features = [
  {
    icon: Wifi,
    title: "إدارة الهوتسبوت",
    desc: "تحكم كامل بمستخدمي الهوتسبوت وإضافة وحذف وتعديل الباقات",
  },
  {
    icon: Users,
    title: "يوزر مانجر",
    desc: "إدارة مستخدمي يوزر مانجر والجلسات والباقات بكل سهولة",
  },
  {
    icon: CreditCard,
    title: "توليد الكروت",
    desc: "توليد كروت مخصصة وطباعتها بقوالب احترافية ورفعها للراوتر",
  },
  {
    icon: BarChart3,
    title: "تقارير المبيعات",
    desc: "تتبع المبيعات والإيرادات مع رسوم بيانية وفلاتر متقدمة",
  },
  {
    icon: Shield,
    title: "نسخ احتياطي",
    desc: "حفظ واستعادة إعدادات المستخدمين تلقائياً",
  },
  {
    icon: Router,
    title: "أجهزة متعددة",
    desc: "إدارة أكثر من راوتر مايكروتيك من لوحة تحكم واحدة",
  },
];
...
const steps = [
  ...
  { num: "2", title: "أضف الراوتر", desc: "أدخل بيانات جهاز المايكروتيك الخاص بك" },
  {
    num: "3",
    title: "ابدأ الإدارة",
    desc: "تحكم بالمستخدمين والكروت والمبيعات من مكان واحد",
  },
];
    ...
    <div className="min-h-dvh bg-background" dir="rtl">
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground text-base sm:text-lg max-w-xl mx-auto mb-8 leading-relaxed">
            لوحة تحكم متكاملة لإدارة الهوتسبوت واليوزر مانجر وتوليد الكروت وتتبع المبيعات — من أي
            مكان.
          </p>
      ...
      <footer className="border-t border-border py-6 text-center">
        <p className="text-xs text-muted-foreground">
          © {new Date().getFullYear()} MikroTik Manager — جميع الحقوق محفوظة
        </p>
      </footer>
    </div>
  );
