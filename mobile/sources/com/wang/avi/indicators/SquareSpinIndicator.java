    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        addUpdateListener(animator, new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                float unused = SquareSpinIndicator.this.rotateX = ((Float) animation.getAnimatedValue()).floatValue();
        ...
        addUpdateListener(animator1, new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                float unused = SquareSpinIndicator.this.rotateY = ((Float) animation.getAnimatedValue()).floatValue();
                SquareSpinIndicator.this.postInvalidate();
            }
        });
