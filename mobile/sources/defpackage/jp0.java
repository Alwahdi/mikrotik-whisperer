...
public class jp0 extends d0<y9, cf0, z7> {
    private static final String a = op0.class.getSimpleName();

    /* renamed from: a  reason: collision with other field name */
    private final LayoutInflater f4085a = LayoutInflater.from(this.f2684a);

    /* renamed from: a  reason: collision with other field name */
    private sp0 f4086a;

    public jp0(Context context, sp0 tableViewModel) {
        super(context);
        this.f4086a = tableViewModel;
    }
    ...
    public com.evrencoskun.tableview.adapter.recyclerview.holder.a d(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 2:
                return new ap(this.f4085a.inflate(R.layout.table_view_image_cell_layout, parent, false));
            case 10:
                return new e20(this.f4085a.inflate(R.layout.table_view_image_cell_layout, parent, false));
            default:
                return new b(this.f4085a.inflate(R.layout.table_view_cell_layout, parent, false));
        }
    }
    ...
    public void j(com.evrencoskun.tableview.adapter.recyclerview.holder.a holder, Object cellItemModel, int columnPosition, int rowPosition) {
        ...
        switch (holder.getItemViewType()) {
            case 2:
                ((ap) holder).a.setImageDrawable(this.f4086a.d(((Integer) cell.d()).intValue(), true));
                return;
            case 10:
                ((e20) holder).a.setImageDrawable(this.f4086a.d(((Integer) cell.d()).intValue(), false));
                return;
            default:
                ((b) holder).e(cell);
                return;
    ...
    public com.evrencoskun.tableview.adapter.recyclerview.holder.a f(ViewGroup parent, int viewType) {
        return new ca(this.f4085a.inflate(R.layout.table_view_column_header_layout, parent, false), b());
    }
    ...
    public com.evrencoskun.tableview.adapter.recyclerview.holder.a e(ViewGroup parent, int viewType) {
        return new kf0(this.f4085a.inflate(R.layout.table_view_row_header_layout, parent, false));
    }
    ...
    class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            com.evrencoskun.tableview.sort.a sortState = jp0.this.b().getRowHeaderSortingStatus();
            ...
            jp0.this.b().f(com.evrencoskun.tableview.sort.a.DESCENDING);
        }
    }

    public View c() {
        View corner = this.f4085a.inflate(R.layout.table_view_corner_layout, (ViewGroup) null);
    ...
    public class b extends com.evrencoskun.tableview.adapter.recyclerview.holder.a {
        ...
        public b(View itemView) {
            super(itemView);
            this.f4087a = (TextView) itemView.findViewById(R.id.cell_data);
            this.a = (LinearLayout) itemView.findViewById(R.id.cell_container);
        }

        public void e(z7 cell) {
            this.f4089a = cell;
            this.f4087a.setText(String.valueOf(cell.d()));
            this.a.getLayoutParams().width = -2;
            this.f4087a.requestLayout();
        }
    }
}
