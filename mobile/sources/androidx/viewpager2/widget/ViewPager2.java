...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attrs) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attrs, a, 0, 0);
        try {
    ...
    private abstract class AccessibilityProvider {
        ...
        /* access modifiers changed from: package-private */
        public void onLmInitializeAccessibilityNodeInfoForItem(@NonNull View host, @NonNull AccessibilityNodeInfoCompat info) {
        }
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        private void addCollectionInfo(AccessibilityNodeInfoCompat infoCompat) {
            ...
            infoCompat.setCollectionInfo(AccessibilityNodeInfoCompat.CollectionInfoCompat.obtain(rowCount, colCount, false, 0));
        }
        ...
        private void addCollectionItemInfo(View host, AccessibilityNodeInfoCompat infoCompat) {
            ...
            int colIndex;
            if (ViewPager2.this.getOrientation() == 1) {
                rowIndex = ViewPager2.this.mLayoutManager.getPosition(host);
            } else {
                rowIndex = 0;
            }
            if (ViewPager2.this.getOrientation() == 0) {
                colIndex = ViewPager2.this.mLayoutManager.getPosition(host);
            } else {
                colIndex = 0;
            }
            infoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(rowIndex, 1, colIndex, 1, false, false));
        }
