...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public android.content.Context attachBaseContext2(@androidx.annotation.NonNull android.content.Context r11) {
        /*
            r10 = this;
            r0 = 1
            ...
            boolean r2 = androidx.appcompat.app.AppCompatDelegate.isAutoStorageOptedIn(r11)
            if (r2 == 0) goto L_0x0014
            androidx.appcompat.app.AppCompatDelegate.syncRequestedAndStoredLocales(r11)
        L_0x0014:
            androidx.core.os.LocaleListCompat r8 = r10.calculateApplicationLocales(r11)
            boolean r2 = sCanApplyOverrideConfiguration
            ...
            r3 = r11
            android.view.ContextThemeWrapper r3 = (android.view.ContextThemeWrapper) r3     // Catch:{ IllegalStateException -> 0x0031 }
            androidx.appcompat.app.AppCompatDelegateImpl.ContextThemeWrapperCompatApi17Impl.applyOverrideConfiguration(r3, r2)     // Catch:{ IllegalStateException -> 0x0031 }
            return r11
        L_0x0031:
            r3 = move-exception
        L_0x0032:
            ...
            android.content.res.Configuration r2 = r2.createOverrideAppConfiguration(r3, r4, r5, r6, r7)
            r3 = r11
            androidx.appcompat.view.ContextThemeWrapper r3 = (androidx.appcompat.view.ContextThemeWrapper) r3     // Catch:{ IllegalStateException -> 0x0047 }
            r3.applyOverrideConfiguration(r2)     // Catch:{ IllegalStateException -> 0x0047 }
            return r11
        L_0x0047:
            r3 = move-exception
        L_0x0048:
            boolean r2 = sCanReturnDifferentContext
        ...
        L_0x0089:
            ...
            r3.<init>((android.content.Context) r11, (int) r4)
            r3.applyOverrideConfiguration(r2)
            android.content.res.Resources$Theme r4 = r11.getTheme()     // Catch:{ NullPointerException -> 0x00a6 }
    ...
    public LocaleListCompat calculateApplicationLocales(@NonNull Context context) {
        ...
        int i = Build.VERSION.SDK_INT;
        if (i >= 33 || (requestedLocales = AppCompatDelegate.getRequestedAppLocales()) == null) {
            return null;
        }
    ...
    /* access modifiers changed from: package-private */
    public void setConfigurationLocales(Configuration conf, @NonNull LocaleListCompat locales) {
        int i = Build.VERSION.SDK_INT;
        if (i >= 24) {
    ...
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(@NonNull MenuBuilder subMenu) {
            ...
            AppCompatDelegateImpl appCompatDelegateImpl = AppCompatDelegateImpl.this;
            if (!appCompatDelegateImpl.mHasActionBar || (cb = appCompatDelegateImpl.getWindowCallback()) == null || AppCompatDelegateImpl.this.mDestroyed) {
                return true;
            }
    ...
    class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        /* access modifiers changed from: package-private */
        public void setActionBarCallback(@Nullable ActionBarMenuCallback callback) {
    ...
    static class Api33Impl {
        ...
        static OnBackInvokedCallback registerOnBackPressedCallback(Object dispatcher, AppCompatDelegateImpl delegate) {
            ...
            OnBackInvokedCallback onBackInvokedCallback = new a(delegate);
            ((OnBackInvokedDispatcher) dispatcher).registerOnBackInvokedCallback(1000000, onBackInvokedCallback);
