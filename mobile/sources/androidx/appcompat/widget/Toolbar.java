...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new tr0(this));
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (shouldBeRegistered && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new sr0(this));
                }
    ...
    static class Api33Impl {
        ...
        @DoNotInline
        static void tryRegisterOnBackInvokedCallback(@NonNull Object dispatcherObj, @NonNull Object callback) {
            ((OnBackInvokedDispatcher) dispatcherObj).registerOnBackInvokedCallback(1000000, (OnBackInvokedCallback) callback);
        }

        @DoNotInline
        static void tryUnregisterOnBackInvokedCallback(@NonNull Object dispatcherObj, @NonNull Object callbackObj) {
