...
class AppCompatTextViewAutoSizeHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(i2)) {
            autoSizeStepGranularityInPx = a.getDimension(i2, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
        }
        int i3 = R.styleable.AppCompatTextView_autoSizeMinTextSize;
        if (a.hasValue(i3)) {
            autoSizeMinTextSizeInPx = a.getDimension(i3, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
        }
        int i4 = R.styleable.AppCompatTextView_autoSizeMaxTextSize;
        if (a.hasValue(i4)) {
            autoSizeMaxTextSizeInPx = a.getDimension(i4, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
        }
    ...
    @VisibleForTesting
    @NonNull
    public StaticLayout createLayout(@NonNull CharSequence text, @NonNull Layout.Alignment alignment, int availableWidth, int maxLines) {
        int i = Build.VERSION.SDK_INT;
        if (i >= 23) {
    ...
    private static final class Api23Impl {
        ...
        @DoNotInline
        @NonNull
        static StaticLayout createStaticLayoutForMeasuring(@NonNull CharSequence text, @NonNull Layout.Alignment alignment, int availableWidth, int maxLines, @NonNull TextView textView, @NonNull TextPaint tempTextPaint, @NonNull Impl impl) {
    ...
    private static final class Api16Impl {
        ...
        @DoNotInline
        @NonNull
        static StaticLayout createStaticLayoutForMeasuring(@NonNull CharSequence text, @NonNull Layout.Alignment alignment, int availableWidth, @NonNull TextView textView, @NonNull TextPaint tempTextPaint) {
