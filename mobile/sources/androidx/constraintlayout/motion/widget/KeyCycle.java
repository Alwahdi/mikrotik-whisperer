...
public class KeyCycle extends Key {
    ...
    public void addCycleValues(HashMap<String, KeyCycleOscillator> oscSet) {
        ...
        for (String key : oscSet.keySet()) {
            if (key.startsWith("CUSTOM") && (cvalue = this.mCustomConstraints.get(key.substring("CUSTOM".length() + 1))) != null && cvalue.getType() == ConstraintAttribute.AttributeType.FLOAT_TYPE) {
