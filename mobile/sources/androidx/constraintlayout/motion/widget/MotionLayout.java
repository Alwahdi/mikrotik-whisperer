...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    private static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f6057me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f6057me.tracker = VelocityTracker.obtain();
            return f6057me;
        }
    ...
    class Model {
        ...
        public void measure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (recompute_start_end_size) {
                ...
                motionLayout3.mWidthMeasureMode = widthMode;
                motionLayout3.mHeightMeasureMode = heightMode;
            ...
            int width2 = motionLayout5.mStartWrapWidth;
            int height2 = motionLayout5.mStartWrapHeight;
            int i3 = motionLayout5.mWidthMeasureMode;
            if (i3 == Integer.MIN_VALUE || i3 == 0) {
                int i4 = motionLayout5.mStartWrapWidth;
                width = (int) (((float) i4) + (motionLayout5.mPostInterpolationPosition * ((float) (motionLayout5.mEndWrapWidth - i4))));
            } else {
                width = width2;
            }
            int i5 = motionLayout5.mHeightMeasureMode;
            if (i5 == Integer.MIN_VALUE || i5 == 0) {
                int i6 = motionLayout5.mStartWrapHeight;
                height = (int) (((float) i6) + (motionLayout5.mPostInterpolationPosition * ((float) (motionLayout5.mEndWrapHeight - i6))));
            } else {
                height = height2;
            }
