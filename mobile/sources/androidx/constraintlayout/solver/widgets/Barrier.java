        ...
        if (i3 >= 0 && i3 < 4) {
            ...
            for (int i7 = 0; i7 < this.mWidgetsCount; i7++) {
                ...
                if (this.mAllowsGoneWidget || widget2.allowedInBarrier()) {
                    ...
                    constraintAnchorArr3[i8].mSolverVariable = target;
                    int margin = 0;
                    if (constraintAnchorArr3[i8].mTarget != null && constraintAnchorArr3[i8].mTarget.mOwner == this) {
                        margin = 0 + constraintAnchorArr3[i8].mMargin;
                    }
                    if (i8 == 0 || i8 == 2) {
