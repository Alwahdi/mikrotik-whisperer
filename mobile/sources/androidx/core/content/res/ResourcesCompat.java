...
public final class ResourcesCompat {
    ...
    private static android.content.res.ColorStateList getCachedColorStateList(@androidx.annotation.NonNull androidx.core.content.res.ResourcesCompat.ColorStateListCacheKey r5, @androidx.annotation.ColorRes int r6) {
        /*
            ...
            android.content.res.Resources$Theme r3 = r5.mTheme     // Catch:{ all -> 0x0045 }
            if (r3 != 0) goto L_0x0031
            int r4 = r2.mThemeHash     // Catch:{ all -> 0x0045 }
            if (r4 == 0) goto L_0x003b
        L_0x0031:
            if (r3 == 0) goto L_0x003f
            int r4 = r2.mThemeHash     // Catch:{ all -> 0x0045 }
            int r3 = r3.hashCode()     // Catch:{ all -> 0x0045 }
            if (r4 != r3) goto L_0x003f
        L_0x003b:
            android.content.res.ColorStateList r3 = r2.mValue     // Catch:{ all -> 0x0045 }
    ...
    private static void addColorStateListToCache(@NonNull ColorStateListCacheKey key, @ColorRes int resId, @NonNull ColorStateList value, @Nullable Resources.Theme theme) {
        synchronized (sColorStateCacheLock) {
    ...
    private static class ColorStateListCacheEntry {
        ...
        ColorStateListCacheEntry(@NonNull ColorStateList value, @NonNull Configuration configuration, @Nullable Resources.Theme theme) {
            this.mValue = value;
    ...
    public static abstract class FontCallback {
        ...
        public final void callbackSuccessAsync(@NonNull Typeface typeface, @Nullable Handler handler) {
            getHandler(handler).post(new oe0(this, typeface));
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public final void callbackFailAsync(int reason, @Nullable Handler handler) {
            getHandler(handler).post(new ne0(this, reason));
        }
    ...
    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public static Typeface getFont(@NonNull Context context, @FontRes int id, @NonNull TypedValue value, int style, @Nullable FontCallback fontCallback) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
    ...
    private static Typeface loadFont(@NonNull Context context, int id, @NonNull TypedValue value, int style, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean isRequestFromLayoutInflator, boolean isCachedOnly) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:56:0x00cd A[ExcHandler: IOException (e java.io.IOException), Splitter:B:14:0x0038] */
    /* JADX WARNING: Removed duplicated region for block: B:63:0x010b  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static android.graphics.Typeface loadFont(@androidx.annotation.NonNull android.content.Context r21, android.content.res.Resources r22, @androidx.annotation.NonNull android.util.TypedValue r23, int r24, int r25, @androidx.annotation.Nullable androidx.core.content.res.ResourcesCompat.FontCallback r26, @androidx.annotation.Nullable android.os.Handler r27, boolean r28, boolean r29) {
        /*
            r11 = r22
            r12 = r23
            r13 = r24
        ...
        L_0x0035:
            ...
            return r16
        L_0x0038:
            java.lang.String r0 = r9.toLowerCase()     // Catch:{ XmlPullParserException -> 0x00ee, IOException -> 0x00cd }
            java.lang.String r1 = ".xml"
            boolean r0 = r0.endsWith(r1)     // Catch:{ XmlPullParserException -> 0x00c6, IOException -> 0x00cd }
            if (r0 == 0) goto L_0x008d
            android.content.res.XmlResourceParser r0 = r11.getXml(r13)     // Catch:{ XmlPullParserException -> 0x00c6, IOException -> 0x00cd }
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r1 = androidx.core.content.res.FontResourcesParserCompat.parse(r0, r11)     // Catch:{ XmlPullParserException -> 0x00c6, IOException -> 0x00cd }
            r17 = r1
            if (r17 != 0) goto L_0x006a
            java.lang.String r1 = "Failed to find font-family tag"
            android.util.Log.e(r10, r1)     // Catch:{ XmlPullParserException -> 0x0064, IOException -> 0x005c }
            if (r14 == 0) goto L_0x005b
            r14.callbackFailAsync(r8, r15)     // Catch:{ XmlPullParserException -> 0x0064, IOException -> 0x005c }
        L_0x005b:
            return r16
        L_0x005c:
            r0 = move-exception
        ...
        L_0x0064:
            ...
            goto L_0x00f4
        L_0x006a:
            int r5 = r12.assetCookie     // Catch:{ XmlPullParserException -> 0x00c6, IOException -> 0x00cd }
            r1 = r21
            r2 = r17
            r3 = r22
            r4 = r24
            ...
            r20 = r10
            r10 = r28
            android.graphics.Typeface r1 = androidx.core.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00ba }
            return r1
        L_0x008d:
            r19 = r6
            r18 = r9
            r20 = r10
            r11 = -3
            int r5 = r12.assetCookie     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00ba }
            r1 = r21
            r2 = r22
            r3 = r24
            r4 = r18
            r6 = r25
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFontFile(r1, r2, r3, r4, r5, r6)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00ba }
            r6 = r0
            if (r14 == 0) goto L_0x00b9
            if (r6 == 0) goto L_0x00ad
            r14.callbackSuccessAsync(r6, r15)     // Catch:{ XmlPullParserException -> 0x00b3, IOException -> 0x00b1 }
            goto L_0x00b9
        L_0x00ad:
            r14.callbackFailAsync(r11, r15)     // Catch:{ XmlPullParserException -> 0x00b3, IOException -> 0x00b1 }
            goto L_0x00b9
        L_0x00b1:
            r0 = move-exception
            goto L_0x00d5
    ...
    static class Api23Impl {
        ...
        @DoNotInline
        @NonNull
        static ColorStateList getColorStateList(@NonNull Resources res, @ColorRes int id, @Nullable Resources.Theme theme) {
