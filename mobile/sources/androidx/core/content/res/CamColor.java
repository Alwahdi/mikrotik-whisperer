...
class CamColor {
    ...
    static int toColor(@FloatRange(from = 0.0d, to = 360.0d) float hue, @FloatRange(from = 0.0d, to = Double.POSITIVE_INFINITY, toInclusive = false) float chroma, @FloatRange(from = 0.0d, to = 100.0d) float lStar) {
    ...
    @NonNull
    static CamColor fromColorInViewingConditions(@ColorInt int color, @NonNull ViewingConditions viewingConditions) {
        float f;
        ...
        float eHue = ((float) (Math.cos(((((double) (((double) hue2) < 20.14d ? hue2 + 360.0f : hue2)) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f;
        ...
        float f21 = bAF;
        float f22 = rA;
        return new CamColor(hue2, c, j, q, m, ((float) Math.sqrt((double) ((viewingConditions.getC() * alpha) / (viewingConditions.getAw() + 4.0f)))) * 50.0f, jstar, ((float) Math.cos((double) hueRadians)) * mstar, ((float) Math.sin((double) hueRadians)) * mstar);
    }

    @NonNull
    private static CamColor fromJch(@FloatRange(from = 0.0d, to = 100.0d) float j, @FloatRange(from = 0.0d, to = Double.POSITIVE_INFINITY, toInclusive = false) float c, @FloatRange(from = 0.0d, to = 360.0d) float h) {
        return fromJchInFrame(j, c, h, ViewingConditions.DEFAULT);
    }

    @NonNull
    private static CamColor fromJchInFrame(@FloatRange(from = 0.0d, to = 100.0d) float j, @FloatRange(from = 0.0d, to = Double.POSITIVE_INFINITY, toInclusive = false) float c, @FloatRange(from = 0.0d, to = 360.0d) float h, ViewingConditions viewingConditions) {
        float f = j;
    ...
    /* access modifiers changed from: package-private */
    public float distance(@NonNull CamColor other) {
    ...
    @ColorInt
    static int toColor(@FloatRange(from = 0.0d, to = 360.0d) float hue, @FloatRange(from = 0.0d, to = Double.POSITIVE_INFINITY, toInclusive = false) float chroma, @FloatRange(from = 0.0d, to = 100.0d) float lstar, @NonNull ViewingConditions viewingConditions) {
    ...
    @Nullable
    private static CamColor findCamByJ(@FloatRange(from = 0.0d, to = 360.0d) float hue, @FloatRange(from = 0.0d, to = Double.POSITIVE_INFINITY, toInclusive = false) float chroma, @FloatRange(from = 0.0d, to = 100.0d) float lstar) {
        float low = 0.0f;
        float high = 100.0f;
