...
public class ShortcutManagerCompat {
    ...
    public static boolean requestPinShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcut, @Nullable final IntentSender callback) {
        ...
        if (i <= 31 && shortcut.isExcludedFromSurfaces(1)) {
            return false;
        }
        if (i >= 26) {
    ...
    public static boolean pushDynamicShortcut(@androidx.annotation.NonNull android.content.Context r7, @androidx.annotation.NonNull androidx.core.content.pm.ShortcutInfoCompat r8) {
        /*
            ...
            boolean r2 = r8.isExcludedFromSurfaces(r1)
        ...
        L_0x002f:
            return r1
        L_0x0030:
            int r2 = getMaxShortcutCountPerActivity(r7)
            r3 = 0
        ...
        L_0x007f:
            ...
            r5[r3] = r6
            java.util.List r5 = java.util.Arrays.asList(r5)
            r0.addDynamicShortcuts(r5)
        L_0x008e:
            androidx.core.content.pm.ShortcutInfoCompatSaver r0 = getShortcutInfoSaverInstance(r7)
            java.util.List r4 = r0.getShortcuts()     // Catch:{ Exception -> 0x0100, all -> 0x00db }
            int r5 = r4.size()     // Catch:{ Exception -> 0x0100, all -> 0x00db }
            if (r5 < r2) goto L_0x00ab
            java.lang.String[] r5 = new java.lang.String[r1]     // Catch:{ Exception -> 0x0100, all -> 0x00db }
            java.lang.String r6 = getShortcutInfoCompatWithLowestRank(r4)     // Catch:{ Exception -> 0x0100, all -> 0x00db }
            r5[r3] = r6     // Catch:{ Exception -> 0x0100, all -> 0x00db }
            java.util.List r5 = java.util.Arrays.asList(r5)     // Catch:{ Exception -> 0x0100, all -> 0x00db }
            r0.removeShortcuts(r5)     // Catch:{ Exception -> 0x0100, all -> 0x00db }
        L_0x00ab:
            androidx.core.content.pm.ShortcutInfoCompat[] r5 = new androidx.core.content.pm.ShortcutInfoCompat[r1]     // Catch:{ Exception -> 0x0100, all -> 0x00db }
            r5[r3] = r8     // Catch:{ Exception -> 0x0100, all -> 0x00db }
            java.util.List r5 = java.util.Arrays.asList(r5)     // Catch:{ Exception -> 0x0100, all -> 0x00db }
            r0.addShortcuts(r5)     // Catch:{ Exception -> 0x0100, all -> 0x00db }
    ...
    @NonNull
    private static List<ShortcutInfoCompat> removeShortcutsExcludedFromSurface(@NonNull List<ShortcutInfoCompat> shortcuts, int surfaces) {
