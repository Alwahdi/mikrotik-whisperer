...
final class WeightTypefaceApi26 {
    ...
    static {
        ...
        try {
            ...
            Class cls = Long.TYPE;
            nativeCreateFromTypefaceWithExactStyle = Typeface.class.getDeclaredMethod(NATIVE_CREATE_FROM_TYPEFACE_WITH_EXACT_STYLE_METHOD, new Class[]{cls, Integer.TYPE, Boolean.TYPE});
