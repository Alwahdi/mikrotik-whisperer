...
final class WeightTypefaceApi21 {
    ...
    static {
        ...
        try {
            ...
            nativeCreateFromTypeface = Typeface.class.getDeclaredMethod(NATIVE_CREATE_FROM_TYPEFACE_METHOD, new Class[]{cls, cls2});
            nativeCreateFromTypeface.setAccessible(true);
            nativeCreateWeightAlias = Typeface.class.getDeclaredMethod(NATIVE_CREATE_WEIGHT_ALIAS_METHOD, new Class[]{cls, cls2});
            nativeCreateWeightAlias.setAccessible(true);
            constructor = Typeface.class.getDeclaredConstructor(new Class[]{cls});
