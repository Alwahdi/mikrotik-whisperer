...
class TypefaceCompatBaseImpl {
    ...
    private static <T> T findBestFont(T[] fonts, int style, StyleExtractor<T> extractor) {
        return findBestFont(fonts, (style & 1) == 0 ? HttpStatus.SC_BAD_REQUEST : 700, (style & 2) != 0, extractor);
    }
    ...
    /* access modifiers changed from: package-private */
    @NonNull
    public Typeface createWeightStyle(@NonNull Context context, @NonNull Typeface base, int weight, boolean italic) {
        Typeface out = null;
        try {
