...
public final class WindowInsetsControllerCompat {
            ...
            switch (type) {
                ...
                case 8:
                    ...
                    if (view != null && view.hasWindowFocus()) {
                        View finalView = view;
                        finalView.post(new a(finalView));
                        return;
                    }
                    return;
                default:
    ...
    private static class Impl30 extends Impl {
        ...
        public void show(int types) {
            ...
            if (!(window == null || (types & 8) == 0 || Build.VERSION.SDK_INT >= 32)) {
        ...
        public void addOnControllableInsetsChangedListener(@NonNull OnControllableInsetsChangedListener listener) {
            if (!this.mListeners.containsKey(listener)) {
                WindowInsetsController.OnControllableInsetsChangedListener fwListener = new b(this, listener);
        ...
        public /* synthetic */ void lambda$addOnControllableInsetsChangedListener$0(OnControllableInsetsChangedListener listener, WindowInsetsController controller, int typeMask) {
