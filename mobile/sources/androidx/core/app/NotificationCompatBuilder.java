...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(NotificationCompat.Builder b) {
        ...
        if (i3 >= 19 && i3 < 21 && (people2 = combineLists(getPeople(b.mPersonList), b.mPeople)) != null && !people2.isEmpty()) {
        ...
        if (i3 >= 21) {
            ...
            if (b.mInvisibleActions.size() > 0) {
                ...
                for (int i4 = 0; i4 < b.mInvisibleActions.size(); i4++) {
                    listBundle.putBundle(Integer.toString(i4), NotificationCompatJellybean.getBundleForAction(b.mInvisibleActions.get(i4)));
                }
        ...
        if (i5 >= 23 && (icon = b.mSmallIcon) != null) {
        ...
        if (i6 >= 31 && (i = b.mFgsDeferBehavior) != 0) {
