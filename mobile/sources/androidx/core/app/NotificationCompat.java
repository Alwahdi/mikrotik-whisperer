...
public class NotificationCompat {
    ...
    public static class BigPictureStyle extends Style {
        ...
        @RequiresApi(31)
        @NonNull
        public BigPictureStyle setContentDescription(@Nullable CharSequence contentDescription) {
        ...
        @RequiresApi(31)
        @NonNull
        public BigPictureStyle bigPicture(@Nullable Icon i) {
    ...
    public static class Action {
        ...
        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        Action(int icon2, @Nullable CharSequence title2, @Nullable PendingIntent intent, @Nullable Bundle extras, @Nullable RemoteInput[] remoteInputs, @Nullable RemoteInput[] dataOnlyRemoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual, boolean requireAuth) {
        ...
        Action(@Nullable IconCompat icon2, @Nullable CharSequence title2, @Nullable PendingIntent intent, @Nullable Bundle extras, @Nullable RemoteInput[] remoteInputs, @Nullable RemoteInput[] dataOnlyRemoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual, boolean requireAuth) {
        ...
        public static final class Builder {
            ...
            private Builder(@Nullable IconCompat icon, @Nullable CharSequence title, @Nullable PendingIntent intent, @NonNull Bundle extras, @Nullable RemoteInput[] remoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual, boolean authRequired) {
    ...
    static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        boolean authRequired = i4 >= 31 ? action.isAuthenticationRequired() : false;
        if (i4 < 23) {
            ...
            return new Action(i, action2.title, action2.actionIntent, action.getExtras(), remoteInputs, (RemoteInput[]) null, allowGeneratedReplies, semanticAction, showsUserInterface, isContextual, authRequired);
        } else {
