...
public abstract class ActivityResultRegistry {
    ...
    @MainThread
    public abstract <I, O> void onLaunch(int i, @NonNull ActivityResultContract<I, O> activityResultContract, I i2, @Nullable ActivityOptionsCompat activityOptionsCompat);
    ...
    private int generateRandomNumber() {
        int number = bd0.a.c(2147418112) + 65536;
        while (this.mRcToKey.containsKey(Integer.valueOf(number))) {
            number = bd0.a.c(2147418112) + 65536;
        }
        return number;
    }
