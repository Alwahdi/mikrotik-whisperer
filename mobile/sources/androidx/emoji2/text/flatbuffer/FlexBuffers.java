...
public class FlexBuffers {
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            ReadBuf readBuf = this.bb;
            int access$200 = FlexBuffers.indirect(readBuf, keysOffset, this.byteWidth);
            ReadBuf readBuf2 = this.bb;
            int i = this.byteWidth;
            return new KeyVector(new TypedVector(readBuf, access$200, FlexBuffers.readInt(readBuf2, keysOffset + i, i), 4));
        }
    ...
    public static class KeyVector {
        ...
        public Key get(int pos) {
            ...
            return new Key(readBuf, FlexBuffers.indirect(readBuf, typedVector.end + (typedVector.byteWidth * pos), typedVector2.byteWidth), 1);
        }
