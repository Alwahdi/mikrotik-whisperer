...
public class EmojiCompat {
    ...
    /* JADX INFO: finally extract failed */
    /* access modifiers changed from: package-private */
    public void onMetadataLoadFailed(@Nullable Throwable throwable) {
        Collection<InitCallback> initCallbacks = new ArrayList<>();
        this.mInitLock.writeLock().lock();
        try {
            this.mLoadState = 2;
    ...
    public static boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = 0) int beforeLength, @IntRange(from = 0) int afterLength, boolean inCodePoints) {
        if (Build.VERSION.SDK_INT >= 19) {
    ...
    @Deprecated
    public boolean hasEmojiGlyph(@NonNull CharSequence sequence, @IntRange(from = 0) int metadataVersion) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkNotNull(sequence, "sequence cannot be null");
        return this.mHelper.hasEmojiGlyph(sequence, metadataVersion);
    }

    public int getEmojiMatch(@NonNull CharSequence sequence, @IntRange(from = 0) int metadataVersion) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkNotNull(sequence, "sequence cannot be null");
    ...
    @CheckResult
    @Nullable
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int start, @IntRange(from = 0) int end) {
        return process(charSequence, start, end, Integer.MAX_VALUE);
    }

    @CheckResult
    @Nullable
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int start, @IntRange(from = 0) int end, @IntRange(from = 0) int maxEmojiCount) {
        return process(charSequence, start, end, maxEmojiCount, 0);
    }

    @CheckResult
    @Nullable
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int start, @IntRange(from = 0) int end, @IntRange(from = 0) int maxEmojiCount, int replaceStrategy) {
        boolean replaceAll;
        Preconditions.checkState(isInitialized(), "Not initialized yet");
    ...
    static class SpanFactory {
        ...
        /* access modifiers changed from: package-private */
        public EmojiSpan createSpan(@NonNull EmojiMetadata metadata) {
    ...
    private static class ListenerDispatcher implements Runnable {
        ...
        ListenerDispatcher(@NonNull InitCallback initCallback, int loadState) {
        ...
        ListenerDispatcher(@NonNull Collection<InitCallback> initCallbacks, int loadState) {
            this(initCallbacks, loadState, (Throwable) null);
        }

        ListenerDispatcher(@NonNull Collection<InitCallback> initCallbacks, int loadState, @Nullable Throwable throwable) {
    ...
    private static class CompatInternal {
        ...
        /* access modifiers changed from: package-private */
        public boolean hasEmojiGlyph(@NonNull CharSequence sequence, int metadataVersion) {
            return false;
        }

        /* access modifiers changed from: package-private */
        public CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = 0) int start, @IntRange(from = 0) int end, @IntRange(from = 0) int maxEmojiCount, boolean replaceAll) {
            return charSequence;
        }
    ...
    private static final class CompatInternal19 extends CompatInternal {
        ...
        /* access modifiers changed from: package-private */
        public CharSequence process(@NonNull CharSequence charSequence, int start, int end, int maxEmojiCount, boolean replaceAll) {
