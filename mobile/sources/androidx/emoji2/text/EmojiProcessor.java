...
final class EmojiProcessor {
    ...
    EmojiProcessor(@NonNull MetadataRepo metadataRepo, @NonNull EmojiCompat.SpanFactory spanFactory, @NonNull EmojiCompat.GlyphChecker glyphChecker, boolean useEmojiAsDefaultStyle, @Nullable int[] emojiAsDefaultStyleExceptions) {
    ...
    /* access modifiers changed from: package-private */
    public int getEmojiMatch(@NonNull CharSequence charSequence, int metadataVersion) {
    ...
    static boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = 0) int beforeLength, @IntRange(from = 0) int afterLength, boolean inCodePoints) {
        int end;
        int start;
    ...
    private void addEmoji(@NonNull Spannable spannable, EmojiMetadata metadata, int start, int end) {
