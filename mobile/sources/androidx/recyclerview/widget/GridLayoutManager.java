        ...
        while (i4 < itemSpanSize) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view5) != maxSize) {
                ...
                if (this.mOrientation == 1) {
                    ...
                    wSpec = RecyclerView.LayoutManager.getChildMeasureSpec(totalSpaceInOther, BasicMeasure.EXACTLY, horizontalInsets, lp.width, false);
                    ...
                    hSpec = RecyclerView.LayoutManager.getChildMeasureSpec(totalSpaceInOther, BasicMeasure.EXACTLY, verticalInsets, lp.height, false);
                }
