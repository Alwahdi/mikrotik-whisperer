...
public abstract class AbstractResolvableFuture<V> implements ox<V> {
    ...
    private static final class SetFuture<V> implements Runnable {
        final ox<? extends V> future;
        final AbstractResolvableFuture<V> owner;

        SetFuture(AbstractResolvableFuture<V> owner2, ox<? extends V> future2) {
            this.owner = owner2;
            this.future = future2;
        }
    ...
    /* JADX WARNING: type inference failed for: r6v6, types: [ox<? extends V>, java.util.concurrent.Future] */
    /* JADX WARNING: Multi-variable type inference failed */
    ...
    static Object getFutureValue(ox<?> future) {
        Object v;
